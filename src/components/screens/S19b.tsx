...
export const S19b: React.FC<ScreenProps> = ({ onNavigate, onCourseCreated, onCourseUpdated, selectedCourse }) => {
  ...
  return (
    <div className="bg-[#f9f9ff] text-[#191c23] min-h-screen flex flex-col font-inter">
      ...
      />
      <Breadcrumb items={['Mis Cursos', isEdit ? 'Editar Curso' : 'Nuevo Curso']} />
