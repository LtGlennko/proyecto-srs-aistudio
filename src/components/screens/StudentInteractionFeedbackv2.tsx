...
export const StudentInteractionFeedbackv2: React.FC<ScreenProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    if (segundos === 0) {
      onNavigate('S22_finalizada');
    }
  }, [segundos, onNavigate]);

  const options = [
    { id: 1, text: 'Verdadero', selected: true },
    { id: 2, text: 'Falso', selected: false },
  ];
