...
export const ConsultaForm: React.FC<ScreenProps> = ({ onNavigate, onSent }) => {
      ...
      <main className="flex-grow pt-[92px] pb-[80px] px-6">
        <div className="mb-8 mt-6">
          ...
          <p className="text-[#727785] text-sm leading-relaxed">
            Envía tu duda al docente para que sea resuelta durante la próxima sesión.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm space-y-6">
          <div className="flex flex-col gap-2">
            ...
            <textarea 
              ...
              defaultValue="¿Podría repetir el ejemplo de matrices?"
            />
          </div>
