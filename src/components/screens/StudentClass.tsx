...
export const StudentClass: React.FC<ScreenProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-[#f9f9ff] text-[#191c23] min-h-screen flex flex-col font-inter relative">
      ...
      <main className="flex-grow pt-[148px] pb-[80px] px-6">
        ...
        <div className="space-y-4">
          <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-100 flex items-start gap-4 transition-all active:scale-[0.98]">
            <div className="w-12 h-12 rounded-full bg-[#005bbf] flex items-center justify-center shrink-0">
              <span className="material-symbols-outlined text-white text-3xl">person</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex justify-between items-start mb-1">
                <div className="flex flex-col gap-1">
                  <span className="font-bold text-[#191c23] text-sm">Juan Pérez (2019000)</span>
                  <div>
                    <span style={{
                      fontSize: '11px',
                      fontWeight: 500,
      ...
      <FABButton onClick={() => onNavigate('S05')} />
