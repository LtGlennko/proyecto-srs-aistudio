...
export const S21c: React.FC<ScreenProps> = ({ onNavigate, hasInteraction, onActivityFinished, questions = [], selectedCourse, selectedActivity, onSetEditingInteraction, activeInteractionId, onToggleActiveInteraction, responseCounts }) => {
